function  navego_plot (ref, gnss, nav_e, gnss_ref, nav_ref, ref_n, ref_g)
% navego_plot: 
%
% INPUT:
...
%   gnss_ref, GNSS data structure interpolated with reference time vector.
%   ref_n, 
%   ref_g, 
%
% OUTPUT
