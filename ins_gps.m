...
for j = 2:Mg
    ...
    qua = qua_n + 0.5 .* [qua_n(4)*eye(3) + antm; -1.*[qua_n(1) qua_n(2) qua_n(3)]] * xp(1:3);
    ...
    vel_e (i,2) = vel_e (i,2) - xp(5);
    vel_e (i,3) = vel_e (i,3) - xp(6);
    
    % Position corrections
    lat_e(i) = lat_e(i) - double(xp(7));
    lon_e(i) = lon_e(i) - double(xp(8));
    h_e(i)   = h_e(i)   - xp(9);
